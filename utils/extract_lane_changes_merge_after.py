...
# namely bypass ego from behind

# extract lane change time sequences
# input: dataset downloaded from the NGSIM website
# output: time sequences of aborted lane changes
# abortion defined as:
# 8s before ego crosses the lane divider, the leading vehicle when ego cross lane divider is actually behind ego,
# namely the leading vehicle bypass ego, or ego choose to merge after leading vehicle
# input: dataset downloaded from the NGSIM website
# output: #
